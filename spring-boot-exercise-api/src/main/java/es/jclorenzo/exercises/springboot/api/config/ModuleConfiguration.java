package es.jclorenzo.exercises.springboot.api.config;
 ...
 */
@EnableWebSecurity
@Configuration(value = "ApiModuleConfiguration")
@ComponentScan(basePackages = { "es.jclorenzo.exercises.springboot.api.controller" })
